...
show_help() {
    ...
    echo ""
    echo "     DEVICE_SpeedportSmart3 \\"
    echo "     DEVICE_Fritz7590        }-> mocking this device"
    echo "     DEVICE_Fritz7490       /"
    ...
    echo "     DATASET_1 -> one data set from speedport"
    echo "     DATASET_2 -> another data set from fritzbox"
    echo ""
